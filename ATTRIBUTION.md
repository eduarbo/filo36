...
Las bibliotecas empaquetadas en `hardware/revF/libraries` proceden de KiCad (CC-BY-SA-4.0 con excepción), daprice (Choc, CC-BY-SA-4.0) y símbolos/huellas propios de Filo36. Los modelos STEP de `hardware/revF/models` son envolventes propias nominales, no modelos oficiales de fabricantes. StepUp y FreeCAD se instalan aparte; no se redistribuye su código en este repo.

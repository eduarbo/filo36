...
| `docs/images/revE-*.png`, `revF-*.png`, `revG-*.png` | Filo36 CAD renders incorporating Piantor-derived design and KLP Lamé | CC-BY-SA-4.0; calculated from attributed meshes, no image retouching |

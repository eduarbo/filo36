...
for text,y,size in [('FILO36 / INTERCHANGEABLE FRAMES',805,35),('Three printable themes. Shared theme palettes on actual raised faces.',755,22),('Actual revH CAD exports. Nominal study; printed fit and fastening untested.',55,20)]:

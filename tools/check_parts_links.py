...
import concurrent.futures,json,re,urllib.request,urllib.error,hashlib
...
report={'checked_at':'2026-09-21','document_sha256':hashlib.sha256(doc.read_bytes()).hexdigest(),'photo_redistribution':False,'links':rows}
(ROOT/'validation/revG-parts-links.json').write_text(json.dumps(report,indent=2)+'\n')

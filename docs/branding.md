...
![Caramel Soft: color and one-ink logo variants](images/branding/flan36-caramel-soft.png)

### B — Drop

A centered caramel drop and a balanced, symmetrical silhouette.

![Caramel Drop: color and one-ink logo variants](images/branding/flan36-caramel-drop.png)
...
![Caramel Outline: color and one-ink logo variants](images/branding/flan36-caramel-outline.png)
...
![Caramel: color logo, monochrome mark, PCB and case application concepts](images/branding/flan36-caramel-concept.png)

### 02 — Split

Two halves form one flan. The most direct connection to the split keyboard.

![Split: divided flan logo with PCB and case application concepts](images/branding/flan36-split-concept.png)

### 03 — Pixel

A coarse pixel silhouette for Handheld, Retro TV and Cyberpunk themes.

![Pixel: retro flan logo with PCB and case application concepts](images/branding/flan36-pixel-concept.png)
